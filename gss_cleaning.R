...
raw_data <- read_csv("/Users/aitingzhang/Desktop/GSS 2016/AAG0Ofp3.csv")
dict <- read_lines("/Users/aitingzhang/Desktop/GSS 2016/gss_dict.txt", skip = 18) # skip is because of preamble content
# Now we need the labels because these are the actual responses that we need
labels_raw <- read_file("/Users/aitingzhang/Desktop/GSS 2016/gss_labels.txt")
